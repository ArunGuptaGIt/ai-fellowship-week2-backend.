"""
router_counts.py - Simple read-only endpoints that just count records

These endpoints let you quickly see how many records are in each table.
Useful for monitoring the database or just checking if data loaded properly.
"""
