"""
customer_router.py - HTTP endpoints for the Customer API

All the endpoints for listing customers, getting details, creating new ones,
updating, and deleting. Each endpoint passes the actual work to the CRUD layer.
"""
