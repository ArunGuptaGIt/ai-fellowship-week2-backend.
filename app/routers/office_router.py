"""
office_router.py - Office location API endpoints

Manage company office locations around the world.
"""
...
from app.schemas.office_schemas import OfficeCreate, OfficeOut, OfficeUpdate, OfficeWithEmployeesOut
