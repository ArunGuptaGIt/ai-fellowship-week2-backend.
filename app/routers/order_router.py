...
Handles all order operations: listing, retrieving, creating, updating, and deleting.
Also has a special endpoint to get orders for a specific customer.
"""
...
from app.schemas.order_schemas import OrderCreate, OrderOut, OrderUpdate, OrderWithDetailsOut
