"""
product_schemas.py - Product validation models

These Pydantic models define what data we accept for product
create/update operations and what we return in responses.
"""
...
from app.schemas.order_schemas import OrderDetailBaseOut
