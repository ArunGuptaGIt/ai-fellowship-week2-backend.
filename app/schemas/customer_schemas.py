"""
customer_schemas.py - Request/response validation

These Pydantic models define what data looks valid when coming from
API requests and what we send back in responses. They also handle
basic field validation (length, type, etc.).
"""
