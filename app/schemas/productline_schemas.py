"""
productline_schemas.py - Product line validation models

Defines what product line data looks valid and what we send back when
returning product line information.
"""
